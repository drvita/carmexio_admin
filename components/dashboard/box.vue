...
export default {
    ...
    computed: {
        classIcon() {
            return {
                [`bg-${this.iconBg}`]: true,
                [`text-${this.iconColor}`]: this.iconBg !== "gray-800" ? false : true,
            };
        }
    }
}
